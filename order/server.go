//go:generate protoc --go_out=./pb --go-grpc_out=./pb --go_opt=paths=source_relative --go-grpc_opt=paths=source_relative --go_opt=Maccount.proto=github.com/VarunRajVR/Golang-Inventory-Management/pb order.proto
package order
...
import (
	...
	account "github.com/VarunRajVR/Golang-Inventory-Management/account"
	catalog "github.com/VarunRajVR/Golang-Inventory-Management/catalog"
	"github.com/VarunRajVR/Golang-Inventory-Management/order/pb"
