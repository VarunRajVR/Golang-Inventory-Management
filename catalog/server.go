//go:generate protoc --go_out=./pb --go-grpc_out=./pb --go_opt=paths=source_relative --go-grpc_opt=paths=source_relative --go_opt=Maccount.proto=github.com/VarunRajVR/Golang-Inventory-Management/pb catalog.proto
package catalog
...
import (
	...
	"github.com/VarunRajVR/Golang-Inventory-Management/catalog/pb"
